...
:class:`~deckui.dui.schema.PackageSpec` objects.  Packages bundled with
...
Typical usage::
    ...
    card = deckui.DuiCard("DashboardCard")
    key  = deckui.DuiKey("IconKey")

    # Register a custom directory — overrides bundled if names collide
    deckui.add_dui_path("~/my-dui-packages")

    # Introspect
    print(deckui.list_dui_packages())
"""
