...
class StackCard(Card):
    ...
    *selectable* elements (e.g. sliders) participate in dial-press
    ...
    Usage::
        ...
        from deckboard.ui.cards import StackCard
        from deckboard.ui.controls import VolumeSlider, BrightnessSlider
        from deckboard.ui.elements import LargeText
    ...
    def add_element(self, element: PanelElement, *, default: bool = False) -> StackCard:
        ...
        if not isinstance(element, (Control, Element)):
            msg = (
                f"Expected a Control or Element instance, got {type(element).__name__}"
            )
            raise TypeError(msg)
